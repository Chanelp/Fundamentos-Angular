...
export class SaludoComponent implements OnInit, OnDestroy, OnChanges {
  ...
  //Input y Output en app.component
  ...
  ngOnChanges(changes: SimpleChanges): void {
    console.log("CAMBIO: Valor Anterior:", changes[this.nombre].previousValue);
    console.log("CAMBIO: Valor Nuevo", changes[this.nombre].currentValue);
  }
